...
void GeneticAlgorithm::recordStatistics(double evalSeconds) {
    ...
    st.meanSteps = (double)totalSteps / n;
    st.meanDistance = sumDistance / n;
    ...
    st.bestSteps = top[0].second->steps;
    st.bestDistance = top[0].second->distance;
